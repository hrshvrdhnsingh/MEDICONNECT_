export const getNearbyPharmacies = async ({ latitude, longitude }) => {
  try {
    ...
    // const URL = `https://api.geoapify.com/v2/places?categories=healthcare.pharmacy&bias=proximity:${longitude},${latitude}&filter=circle:${longitude},${latitude},8000&limit=20&apiKey=27a16b03f7004760bdb8cd24144c0505`;
    // console.log({ URL });
