    ...
    <div className={styles.nav_bar}>
      <header className={styles.header}>
        ...
        <nav className={`${styles.navbar} ${menuOpen ? styles.active : ""}`}>
          ...
          <Link href='/dashboard' type="button" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-3 py-2.5 text-center">Dashboard</Link>
        </nav>
      </header>
    </div>
  );
