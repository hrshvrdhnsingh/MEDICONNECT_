                ...
                <div className={styles.card_wrapper}>
                    ...
                    >
                        ...
                        <p
                            ...
                            data-aos-delay="100"
                        >
                            Empower yoursef with proactive healthcare choices. Predict potential
                            diseases from symptoms and swiftly discover nearby hospitals.
                        </p>
                    </Link>
                    <div
                        className={`${styles.image_container} ${styles["data-aos"]} ${styles["data-aos-easing"]} ${styles["data-aos-delay"]}`}
                ...
                <div className={styles.card_wrapper}>
                    ...
                    >
                        ...
                        <p
                            ...
                            data-aos-delay="100"
                        >
                            Look no further if you require personalised nutrition plans and diet
                            charts tailored to every individual.
                        </p>
                    </Link>
                    <div
                        className={`${styles.image_container} ${styles["data-aos"]} ${styles["data-aos-easing"]} ${styles["data-aos-delay"]}`}
