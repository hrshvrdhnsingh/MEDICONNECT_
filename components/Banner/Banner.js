  ...
  return (
    <div className="w-screen">
      ...
      <div className={styles.banner_wrapper}>
        <div className="text-8xl font-medium flex items-center justify-center text-blue-800 w-full h-full mt-16">
          MediConnect
        </div>
        ...
        <div className="vid_container bg-blue-400/20 backdrop-blur-md flex items-center justify-center w-[53vw] h-[60vh] px-4 py-4 rounded-3xl" >
