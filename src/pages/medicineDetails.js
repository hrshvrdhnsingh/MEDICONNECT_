...
// Simple component to get the medicine details
    ...
    return (
        <div className={styles.medicine_bg}>
            ...
            <div className="flex justify-center min-h-max flex-wrap w-11/12 mt-8">
                {loading ? (
                    <div className="fixed top-0 left-0 h-screen flex justify-center items-center bg-[#0116726b]">
                        <PageLoader />
                    </div>
                ) : (
                    <>
                                    ...
                                    >
                                        ...
                                        {medicine.form && (
                                            <p className="text-gray-400">
                                                Description :{" "}
                                                {medicine.form.length > 35
                                                    ? medicine.form.slice(0, 35) + "..."
                                                    : medicine.form}
                                            </p>
                                        )}
                                        <button
                                            ...
                                            onClick={() =>
                                                window.open(medicine.product_url, "_blank")
                                            }
                                        >
