...
export default async function handler(req, res) {
    ...
    try {
        ...
        // The firebase id has been stored in the database, this route is called to save the user-details
        const user = await User.findOneAndUpdate(
            { uid: decoded.uid }, // Each firebase user maps to one Mongo user. The fir
            {
                fullname,
                email: decoded.email,
                age,
